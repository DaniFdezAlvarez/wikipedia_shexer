...
==== Tertiary sources ====
{{refbegin|35em|indent=yes}}
* {{cite web|url=http://www.allmusic.com/style/anarchist-punk-ma0000011967|title=Anarchist Punk|website=AllMusic|access-date=1 August 2020|ref={{harvid|AllMusic}}}}
...
* {{cite book|last=Huemer|first=Micheal|year=2012|title=The Problem of Political Authority: An Examination of the Right to Coerce and the Duty to Obey|location=London|publisher=Palgrave Macmillan|isbn=978-1-137-28164-7}} A defence of philosophical anarchism, arguing that &quot;both kinds of 'anarchism' [i.e. philosophical and political anarchism] are philosophical and political claims.&quot; (p. 137)
    ...
    def extract_model_abstract(xml_node):
        ...
        if len(text_node) == 1:
            ...
            if text.startswith("#REDIRECT"):
                print("redirected page!")
            else:
                stuff = wtp.parse(text)
                print(len(stuff.sections))
