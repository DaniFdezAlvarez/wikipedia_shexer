from wikipedia_shexer.model.rdf import Iri, Property, Literal, BNode
from wikipedia_shexer.utils.uri import remove_corners, parse_literal, parse_unquoted_literal, FLOAT_TYPE, INTEGER_TYPE
